"""Reproduce frozen-v6 comparisons and enforce v7 development release floors."""
import json
import os
...
out = Path(sys.argv[1]).resolve() if len(sys.argv) > 1 else root / "LocalModel/accuracy-v7/recheck"
...
for name, fixture in fixtures.items():
    ...
    env.update(LOCAL_ACCURACY_BASELINE="ab8bc42", LOCAL_ACCURACY_CASES="LocalModel/" + fixture,
    ...
    stats = {}
    for version in ["ab8bc42", "current"]:
