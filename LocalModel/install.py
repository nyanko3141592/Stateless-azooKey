...
for demo in [False,True]:
 dst=Path.home()/('Applications/azooKey Local Demo.app' if demo else 'Library/Input Methods/azooKeyLocal.app')
 ...
 bundle='dev.naoki.azooKeyLocalDemo' if demo else 'dev.naoki.inputmethod.azooKeyLocal'
 d.update(CFBundleIdentifier=bundle,CFBundleDisplayName='azooKey Local',CFBundleName='azooKey Local')
 if demo:
 ...
 localization.write_text('CFBundleDisplayName = "azooKey Local";\nCFBundleName = "azooKey Local";\n',encoding='utf-16')
