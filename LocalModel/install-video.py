...
dst=Path.home()/'Applications/azooKey Local Video.app'
if dst.exists():shutil.rmtree(dst)
shutil.copytree(a.built_app,dst,symlinks=True)
info=dst/'Contents/Info.plist';d=plistlib.loads(info.read_bytes())
d.update(CFBundleIdentifier='dev.naoki.azooKeyLocalVideo',CFBundleName='azooKey Local Video',CFBundleDisplayName='azooKey Local Video',StatelessDemoDefault=True,SegmentationVideoDefault=True,LSUIElement=False,LSBackgroundOnly=False)
...
(dst/'Contents/Resources/en.lproj/InfoPlist.strings').write_text('CFBundleDisplayName = "azooKey Local Video";\nCFBundleName = "azooKey Local Video";\n',encoding='utf-16')
