// Frozen 60a4e9f inference for same-input comparisons; test target only.
import Foundation
@testable import Core

/// A trained logistic language classifier. Inference is pure Swift and never opens a socket.
public final class AccuracyBaselineRouter: @unchecked Sendable {
    ...
    public static let shared: AccuracyBaselineRouter = {
        do { return try AccuracyBaselineRouter() }
